...
## 신규 Excalidraw 다이어그램 (편집 가능)

### 7. NQL 파이프라인 아키텍처

**파일:** [`docs/diagrams/architecture.excalidraw.json`](docs/diagrams/architecture.excalidraw.json)

- NQL 처리 8단계
- 색상 구분으로 시각성 개선
- [excalidraw.com](https://excalidraw.com)에서 편집 가능

---

### 8. 데이터 파이프라인 아키텍처

**파일:** [`docs/diagrams/data-pipeline.excalidraw.json`](docs/diagrams/data-pipeline.excalidraw.json)
...
**파일:** [`docs/diagrams/rrf-scoring.excalidraw.json`](docs/diagrams/rrf-scoring.excalidraw.json)
